# -*- coding: utf-8 -*-
"""
Created on Fri Jul 16 11:48:28 2010
...
def h5info(filename, output=None, print_on=True):
    """\
    h5info(filename)
    ...
    optional argument "print_on":
    Set to false to suppress output of function to stdout.
    """
